...
Class CouponURLsDataSaver implements Subscriber
{
    ...
    {
        // the actual nonce is checked in static::validator() right below this method
        if (!wp_verify_nonce(sanitize_text_field(wp_unslash($_POST[Env::getWithPrefix('dashboard_nonce')] ?? null)), Env::getWithPrefix('dashboard_nonce'))) {
            $requestData = _($_POST);
        };
